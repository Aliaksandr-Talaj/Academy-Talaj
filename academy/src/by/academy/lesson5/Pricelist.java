...
public final class Pricelist {
	...
	public static Food 		energetik= new Food		("Энергетик",	50, "Добавь ещё деньжат и сможешь нанять настоящего инженера-энергетика", 2);	
	public static Medicine 	bint 	= new Medicine	("Бинт", 		80, "\"Рамзес\", стерильный ",7);
	public static Medicine 	aptechka = new Medicine	("Аптечка", 	250,"Коробочка с крестиком, спасающая от коробочки под крестиком", 8);
